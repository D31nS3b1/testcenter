...
class SessionController extends Controller {
  ...
  public static function putSessionAdmin(Request $request, Response $response): Response {
    sleep(5); // 5s delay to slow down brute force attack TODO remove this for better solution to prevent DOS attacks as sleep clocks the server when parallel requests are made
